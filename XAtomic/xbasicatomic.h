...
public:
    ...
    bool ref() noexcept { return Ops::ref(m_x_value); }
    bool deref() noexcept { return Ops::deref(m_x_value); }
    ...
    { return Ops::fetchAndAndRelaxed(m_x_value, valueToAdd); }
    T fetchAndAndAcquire(const T &valueToAdd) noexcept
    { return Ops::fetchAndAndAcquire(m_x_value, valueToAdd); }
    T fetchAndAndRelease(const T &valueToAdd) noexcept
    { return Ops::fetchAndAndRelease(m_x_value, valueToAdd); }
    T fetchAndAndOrdered(const T &valueToAdd) noexcept
    { return Ops::fetchAndAndOrdered(m_x_value, valueToAdd); }

    T fetchAndOrRelaxed(const T &valueToAdd) noexcept
    { return Ops::fetchAndOrRelaxed(m_x_value, valueToAdd); }
    T fetchAndOrAcquire(const T &valueToAdd) noexcept
    { return Ops::fetchAndOrAcquire(m_x_value, valueToAdd); }
    T fetchAndOrRelease(const T &valueToAdd) noexcept
    { return Ops::fetchAndOrRelease(m_x_value, valueToAdd); }
    T fetchAndOrOrdered(const T &valueToAdd) noexcept
    { return Ops::fetchAndOrOrdered(m_x_value, valueToAdd); }

    T fetchAndXorRelaxed(const T &valueToAdd) noexcept
    { return Ops::fetchAndXorRelaxed(m_x_value, valueToAdd); }
    T fetchAndXorAcquire(const T &valueToAdd) noexcept
    { return Ops::fetchAndXorAcquire(m_x_value, valueToAdd); }
    T fetchAndXorRelease(const T &valueToAdd) noexcept
    { return Ops::fetchAndXorRelease(m_x_value, valueToAdd); }
    T fetchAndXorOrdered(const T &valueToAdd) noexcept
    { return Ops::fetchAndXorOrdered(m_x_value, valueToAdd); }
    ...
    explicit constexpr XBasicAtomicInteger(const T &value) noexcept : m_x_value(value) {}
