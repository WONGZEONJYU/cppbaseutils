...
template<XUtils::Awaitable _>
struct is_awaitable
{ static constexpr auto value { true }; };

template<XUtils::Awaitable T>
inline constexpr auto is_awaitable_v { is_awaitable<T>::value };
...
class TestConstraints : public QObject {
    Q_OBJECT
private Q_SLOTS:
    static void testAwaitableConcept() {

        static_assert(helper::is_awaitable_v<XUtils::XCoroTask<>>,
                      "Awaitable concept doesn't accept Task<void>, although it should.");
        static_assert(helper::is_awaitable_v<XUtils::XCoroTask<int>>,
                      "Awaitable concept doesn't accept Task<T>, although it should.");
        static_assert(helper::is_awaitable_v<XUtils::XCoroLazyTask<>>,
