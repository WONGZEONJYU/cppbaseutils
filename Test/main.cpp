...
[[maybe_unused]] static void test6(){
    ...
    auto p2 = xtd::XSecondConstruct<CTest>::CreateUniquePtr(xtd::Parameter{1},xtd::Parameter{1,1});
    delete xtd::XSecondConstruct<CTest>::Create(xtd::Parameter{},xtd::Parameter{});
